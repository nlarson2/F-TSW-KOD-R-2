...
//--------------------------------------------------------------------
//
//Modified by: Nickolas Larson && Marbien Jimeno
//Date: 3/21/2019
//
//Special changes are noted throughout the program to signal a change
//
//Changed all braces to K&R style
//	Spacing for if/while condition from braces and parenthesis
//Limited lines to 80 characters
//Changed function braces	
...
/***NL**/
/*changed to const int*//*prev cosnt: MAX_READ_ERROS*/
...
int main(int argc, char *argv[])
{
  ...
  BIO *outbio = nullptr;
  /*NL*/
  /*Changed SSL_METHOD TO CONST*//*prev: SSL_METHOD *method */
