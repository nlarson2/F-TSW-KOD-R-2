FFLAGS = main.cpp nicholasJo.cpp brandonH.cpp nickolasL.cpp marbienJ.cpp adamO.cpp maps.cpp log.cpp profiling.cpp 
HFLAGS = nicholasJo.h brandonH.h nickolasL.h marbienJ.h adamO.h maps.h serverCon.cpp
